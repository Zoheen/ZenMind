...
const colorPalettes = {
  sunset: {
    background: 'bg-gradient-to-br from-[#EBEF95] to-[#EB5A3C]',
    text: 'text-gray-900'
  },
  ocean: {
    background: 'bg-gradient-to-br from-[#BDCDD6] to-[#1F509A]',
    text: 'text-gray-900'
  },
  forest: {
    background: 'bg-gradient-to-br from-[#D3F1DF] to-[#1F4529]',
    text: 'text-gray-900'
  },
  twilight: {
    background: 'bg-gradient-to-br from-[#EFB6C8] to-[#673F69]',
    text: 'text-gray-900'
  }
};
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl max-w-md w-full">
              ...
              <button
                ...
                className={`p-3 rounded-lg text-sm ${
                  timeInMinutes === preset.value && !isCustom
                    ? 'bg-[#237658] text-white' // Forest green
                    : 'bg-[#237658] text-white'
                }`}
              >
                {preset.label}
              </button>
        ...
        <div className="text-center mb-8 ">
          ...
          <div className="flex justify-center gap-4">
            <button
              onClick={toggleTimer}
              className="bg-[#F2827F] text-white p-4 rounded-full hover:bg-[#FF6347] transition-colors" // Coral pink and hover red
            >
